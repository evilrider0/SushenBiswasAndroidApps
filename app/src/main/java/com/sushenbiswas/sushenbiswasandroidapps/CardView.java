...
public class CardView extends AppCompatActivity {
    ...
    private String baseURL = "http://www.sushenbiswas.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayoutManager = new LinearLayoutManager(CardView.this, LinearLayoutManager.VERTICAL, false);
        ...
        adapter = new RecyclerViewAdapter( list, CardView.this);
